...
from nbgrader.auth.jupyterhub import (JupyterhubEnvironmentError, get_jupyterhub_api_url,
...
class CourseListHandler(APIHandler):
...
def setup_handlers(lab_app):
    ...
    lab_app.web_app.settings['assignment_dir'] = lab_app.notebook_dir
    route_pattern = url_path_join(base_url, "course_list", "get_example")
    handlers = [
        (url_path_join(base_url, "course_list", "formgraders"), CourseListHandler),
