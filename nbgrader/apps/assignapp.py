...
class AssignApp(BaseNbConvertApp):
    ...
    examples = """
        ...
        the directory structure specified in `BaseNbGraderApp.directory_structure`.
    ...
    def build_extra_config(self):
        ...
        extra_config.BaseNbGraderApp.student_id = '.'
        extra_config.BaseNbGraderApp.notebook_id = '*'
        return extra_config
