...
class TestNbGraderAutograde(BaseTestApp):
    ...
    def test_grade(self, db, course_dir):
        ...
        run_nbgrader(["db", "student", "add", "foo", "--db", db])
        run_nbgrader(["db", "student", "add", "bar", "--db", db])
        run_nbgrader(["db", "student", "add", "\\student1", "--db", db])
        ...
        self._copy_file(join("files", "submitted-changed.ipynb"), join(course_dir, "submitted", "\\student1", "ps1", "p1.ipynb"))
        run_nbgrader(["autograde", "ps1", "--db", db])
        ...
        assert os.path.isfile(join(course_dir, "autograded", "\\student1", "ps1", "p1.ipynb"))
        assert not os.path.isfile(join(course_dir, "autograded", "\\student1", "ps1", "timestamp.txt"))
