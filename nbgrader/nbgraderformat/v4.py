...
def read_v4(source: typing.io.TextIO, as_version: int, **kwargs: typing.Any) -> NotebookNode:
    nb = _read(source, as_version, **kwargs)
    MetadataValidatorV4().validate_nb(nb)
    return nb


def write_v4(nb: NotebookNode, fp: typing.io.TextIO, **kwargs: typing.Any) -> None:
    MetadataValidatorV4().validate_nb(nb)
    _write(nb, fp, **kwargs)
