...
<script src="{{base_url}}/static/js/formgrade.js"></script>
    ...
    <div class="container">
      <div class="col-md-2">
        <ul class="nav navbar-nav navbar-left">
          {%- if resources.prev -%}
          <li class="previous">
            <a data-toggle="tooltip" data-placement="right" title="{{ resources.index }} remaining" href="{{base_url}}/submissions/{{ resources.prev }}">
            &larr; Prev
            </a>
          </li>
          {%- else -%}
      ...
      <div class="col-md-8">
        <ul class="nav text-center">
          <ul class="breadcrumb">
            ...
            <li><a href="{{base_url}}/assignments/{{ resources.assignment_id }}">{{ resources.assignment_id }}</a></li>
            <li><a href="{{base_url}}/assignments/{{ resources.assignment_id }}/{{ resources.notebook_id }}">{{ resources.notebook_id }}</a></li>
      ...
      <div class="col-md-2">
        <ul class="nav navbar-nav navbar-right">
          {%- if resources.next -%}
          <li class="next">
            <a data-toggle="tooltip" data-placement="left" title="{{ resources.total - (resources.index + 1) }} remaining" href="{{base_url}}/submissions/{{ resources.next }}">
            Next &rarr;
            </a>
          </li>
          {%- else -%}
